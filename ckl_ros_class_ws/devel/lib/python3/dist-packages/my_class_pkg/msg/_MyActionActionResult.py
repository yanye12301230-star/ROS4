...
"""autogenerated by genpy from my_class_pkg/MyActionActionResult.msg. Do not edit."""
import codecs
import sys
...
class MyActionActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "my_class_pkg/MyActionActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','my_class_pkg/MyActionResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MyActionActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = my_class_pkg.msg.MyActionResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = my_class_pkg.msg.MyActionResult()
