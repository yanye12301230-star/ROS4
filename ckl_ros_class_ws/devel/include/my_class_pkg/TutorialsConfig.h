...
#ifndef __my_class_pkg__TUTORIALSCONFIG_H__
#define __my_class_pkg__TUTORIALSCONFIG_H__
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __default__.size = 1;
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(TutorialsConfig::AbstractParamDescriptionConstPtr(new TutorialsConfig::ParamDescription<int>("size", "int", 0, "A size parameter which is edited via an enum", "{'enum': [{'name': 'Small', 'type': 'int', 'value': 0, 'srcline': 15, 'srcfile': '/home/bcsh/ckl_ros_class_ws/src/my_class_pkg/cfg/Tutorials.cfg', 'description': 'A small constant', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Medium', 'type': 'int', 'value': 1, 'srcline': 16, 'srcfile': '/home/bcsh/ckl_ros_class_ws/src/my_class_pkg/cfg/Tutorials.cfg', 'description': 'A medium constant', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Large', 'type': 'int', 'value': 2, 'srcline': 17, 'srcfile': '/home/bcsh/ckl_ros_class_ws/src/my_class_pkg/cfg/Tutorials.cfg', 'description': 'A large constant', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'ExtraLarge', 'type': 'int', 'value': 3, 'srcline': 18, 'srcfile': '/home/bcsh/ckl_ros_class_ws/src/my_class_pkg/cfg/Tutorials.cfg', 'description': 'An extra large constant', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'An enum to set size'}", &TutorialsConfig::size)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(TutorialsConfig::AbstractParamDescriptionConstPtr(new TutorialsConfig::ParamDescription<int>("size", "int", 0, "A size parameter which is edited via an enum", "{'enum': [{'name': 'Small', 'type': 'int', 'value': 0, 'srcline': 15, 'srcfile': '/home/bcsh/ckl_ros_class_ws/src/my_class_pkg/cfg/Tutorials.cfg', 'description': 'A small constant', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Medium', 'type': 'int', 'value': 1, 'srcline': 16, 'srcfile': '/home/bcsh/ckl_ros_class_ws/src/my_class_pkg/cfg/Tutorials.cfg', 'description': 'A medium constant', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Large', 'type': 'int', 'value': 2, 'srcline': 17, 'srcfile': '/home/bcsh/ckl_ros_class_ws/src/my_class_pkg/cfg/Tutorials.cfg', 'description': 'A large constant', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'ExtraLarge', 'type': 'int', 'value': 3, 'srcline': 18, 'srcfile': '/home/bcsh/ckl_ros_class_ws/src/my_class_pkg/cfg/Tutorials.cfg', 'description': 'An extra large constant', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'An enum to set size'}", &TutorialsConfig::size)));
...
//#line 15 "/home/bcsh/ckl_ros_class_ws/src/my_class_pkg/cfg/Tutorials.cfg"
      const int Tutorials_Small = 0;
//#line 16 "/home/bcsh/ckl_ros_class_ws/src/my_class_pkg/cfg/Tutorials.cfg"
      const int Tutorials_Medium = 1;
//#line 17 "/home/bcsh/ckl_ros_class_ws/src/my_class_pkg/cfg/Tutorials.cfg"
      const int Tutorials_Large = 2;
//#line 18 "/home/bcsh/ckl_ros_class_ws/src/my_class_pkg/cfg/Tutorials.cfg"
